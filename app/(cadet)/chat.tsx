...
export default function CadetChat() {
    ...
    useEffect(() => {
        ...
        const chatRoomRef = doc(db, 'messages', userProfile.uid);
        // Initialize chat room if it doesn't exist (done implicitly when updating)
        // But for listening to messages, we listen to subcollection
        ...
        // Mark as read by cadet (set unreadByCadet: false)
        setDoc(chatRoomRef, { unreadByCadet: false }, { merge: true });
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            await setDoc(chatRoomRef, {
                cadetName: userProfile.fullName || 'Cadet',
                lastMessage: text,
        ...
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <View>
                    ...
                    <Text style={styles.subtitle}>Response time varies</Text>
                </View>
            </View>
            ...
            >
                {loading ? (
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => {
                            const isMe = item.senderRole === 'cadet';
                            return (
                        ...
                        ListEmptyComponent={
                            <View style={styles.empty}>
                                ...
                                <Text style={styles.emptyText}>Send a message to admin.</Text>
                            </View>
                        }
                    />
                )}
